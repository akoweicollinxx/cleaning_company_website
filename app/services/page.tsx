        ...
        <section className="py-20 px-6">
          <div className="max-w-7xl mx-auto">
            <motion.div
              ...
              className="mb-32"
            >
              <h1 className="text-6xl md:text-9xl font-black text-zinc-900 dark:text-white tracking-tighter leading-[0.8] mb-12">
                OUR <br />
            ...
            <div className="mt-40 grid grid-cols-1 md:grid-cols-2 gap-px bg-zinc-100 dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-900 overflow-hidden rounded-[3rem]">
              {[
                ...
                <div key={i} className="bg-white dark:bg-zinc-950 p-16">
            ...
            <div className="mt-40 text-center">
              <h2 className="text-4xl md:text-6xl font-black text-zinc-900 dark:text-white mb-10 tracking-tighter uppercase">Need a Tailored Quote?</h2>
              <Link 
                href="/contact"
